...
## 🎯 Business Objectives
- Track national UPI growth and usage behavior
...
## 🗂 Dataset Description
Primary Source: **upi_transactions_2024.csv**

| Attribute | Description |
|----------|-------------|
| Transaction ID | Unique identifier |
| Date & Time | Timestamp of transaction |
| Bank / PSP | Payment service provider |
| Transaction Type | P2P, P2M, etc. |
...
- Monthly & Daily trend analytics
- Regional & PSP performance ranking
- Status-wise breakdown (Success vs Failed)
...
| Power Query | Preprocessing & Data Cleaning |
...
- Clean relationship mapping for performance
...
## 🔮 Future Enhancements
- Real-time data integration for live insights
- Fraud risk modeling with ML capabilities
- RLS (Row-Level Security) for secure access
- NPCI benchmarking & demographic context

---

## 🖼 Dashboard Preview  

 <img width="1333" height="749" alt="image" src="https://github.com/user-attachments/assets/498650c3-55fe-4fbe-a86a-8ced2546906c" />
